          ...
          {login ? (
            <>
              ...
              <Text>
                ...
                <TextButton onClick={() => setOpenAuth("signup")}>Sign Up</TextButton>
              </Text>
            </>
          ) : (
            <>
              ...
              <Text>
                ...
                <TextButton onClick={() => setOpenAuth("signin")}>Sign In</TextButton>
              </Text>
            </>
          )}
        </Right>
